...
then
    ...
    then
      if [ ${version} == "Nominal" ];
      then
        #WPs_FullVer_vs_QCD=(["1p0"]="0.490" ["0p5"]="0.738" ["0p1"]="0.957") #0: 1p0, 1: 0p5, 2: 0p1
        WPs_FullVer_vs_QCD=(["1p0"]="0.495" ["0p5"]="0.733" ["0p1"]="0.958") #0: 1p0, 1: 0p5, 2: 0p1
      fi    
    fi
elif [ ${object} == "W" ];
then   
    ...
    then
      ...
      then
        mist_rates=("5p0" "1p0" "0p5")
        #mist_rates=("5p0")
        #WPs_FullVer_vs_QCD=(["5p0"]="0.677" ["1p0"]="0.935" ["0p5"]="0.974") #0: 5p0, 1: 1p0, 2: 0p5
        WPs_FullVer_vs_QCD=(["5p0"]="0.668" ["1p0"]="0.934" ["0p5"]="0.974") #0: 5p0, 1: 1p0, 2: 0p5
      elif [ ${version} == "MD" ];
      then
        mist_rates=("2p5" "1p0" "0p5")
        #WPs_FullVer_vs_QCD=(["2p5"]="0.637" ["1p0"]="0.845" ["0p5"]="0.910") #0: 2p5, 1: 1p0, 2: 0p5
        WPs_FullVer_vs_QCD=(["2p5"]="0.642" ["1p0"]="0.842" ["0p5"]="0.907") #0: 2p5, 1: 1p0, 2: 0p5
      fi 
    fi
fi 
